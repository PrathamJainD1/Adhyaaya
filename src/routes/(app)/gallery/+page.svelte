...
<div style="--bg: url('{bg}');" class="fixed h-screen w-screen -z-50 bg opacity-50" />
...
>
	...
	<div class="flex flex-col items-center justify-center pb-12 pt-12">
		<h1 class="text-2xl font-bold text-center text-white nunu">2025</h1>
	</div>
	<Splide {options} aria-label="2025" id="2025">
		{#each images2025 as image}
			<SplideSlide>
				<img src="/gallery/2025/{image}" alt="" class="mx-auto max-h-[50vh] rounded-2xl" />
			</SplideSlide>
		{/each}
	</Splide>
